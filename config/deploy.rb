...
set :repository, "git://github.com/mikeyhogarth/Nomelette.git"
 
set :scm, :git
 
# set :deploy_to "/u/apps/#{application}"
 
role :web, "www.nomelette.co.uk" # Your HTTP server, Apache/etc
role :app, "www.nomelette.co.uk" # This may be the same as your `Web` server
role :db, "www.nomelette.co.uk", :primary => true # This is where Rails migrations will run
